...
`gotth-portability` versions independently under Semantic Versioning. A version number
...
5. Verify exact head and tag parity at
   `github.com/gotthboard/gotth-portability` through the existing one-way push
   mirror.

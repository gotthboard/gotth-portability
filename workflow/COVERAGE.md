...
| PORT-008 | spec/errors | classified and joined errors, strict I/O contracts, explicit raw causes | exact combined class sets and causes, every-sentinel spoofing, Error-string redaction/raw-Cause tests | covered |
...
The hardened source reports 94.9% statement coverage. The exact residual
